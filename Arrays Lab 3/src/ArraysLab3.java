...
public class ArraysLab3 {
	 ...
	 * in which every element is the sum of the elements at that index for the arrays arr1 and arr2. You can assume
	 *  arrays arr1 and arr2 have at least one element each and are the same length.
	 */
	...
	/*
	 * Write a method append that accepts an array of integers arr of length n and an integer num, and returns an array
	 *  of integers of length n+1 that consists of the elements of arr with num appended to the end.  You can assume array 
	...
	/*
	 * Write a method remove that accepts an array of integers arr and an integer idx and returns an array of integers 
	...
	/*
	 * Write a method sumEven that accepts an array of integers arr and returns an integer containing the
	 *  sum of the elements at the even indices of arr.  (That means elements at indices 0,2,4,6,8.)  
	...
	/*
	 * Write a method rotateRight that accepts an array of integers arr and does not return a value.  The rotateRight method 
	 * moves each element of arr one index to the right (element 0 goes to element 1, element 1 goes to element 2, …,
	 *  element n-1 goes to element 0).  You can assume arr has at least one element.
	 */
